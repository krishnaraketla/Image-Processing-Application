...
public class PNGImage extends AbstractImage {
   ...
   */
  public PNGImage(int width, int height, List<Pixel> pixelList, String imageName) {
    this.width = width;
    this.height = height;
  ...
  /**
   * Constructor to load a PNG image from file.
   *
   * @param filename  name of file
   * @param imageName name of image being loaded
   * @throws IOException throw exception if file invalid
   */
  public PNGImage(String filename, String imageName) throws IOException {
    this.imageType = ImageType.PNG;
